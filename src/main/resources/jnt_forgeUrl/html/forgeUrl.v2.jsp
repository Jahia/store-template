...
<div class="input-append">
    ...
    <button id="copyForgeUrl${currentNode.identifier}" class="btn" type="button" data-clipboard-text="${siteUrl}" title="${copyToClipboard}"><i class="glyphicon glyphicon-screenshot"></i></button>
</div>
