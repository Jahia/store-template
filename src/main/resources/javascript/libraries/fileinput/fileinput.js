...
(function (factory) {
    ...
    tModalMain = '<div id="' + MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' +
        MODAL_ID + 'Label" data-focus-on="input:first"></div>';
    ...
    FileInput.prototype = {
        ...
        _getZoomButton: function (type) {
            ...
            var dismissAttribute = "";
            if (type === 'fullscreen' || type === 'borderless' || type === 'toggleheader') {
                params += ' data-toggle="button" aria-pressed="false" autocomplete="off"';
            }
            if(type === 'close'){
                dismissAttribute='data-dismiss="modal"';
            }
            return '<button type="button" class="' + css + ' btn-' + type + '"' + params + ' '+dismissAttribute+'>' + label + '</button>';
        },
        _getModalContent: function () {
            ...
            var modalObj = self.$modal;
            modalObj.attr('tabindex','-1');
            modalObj.attr('data-focus-on','input:first');
        },
