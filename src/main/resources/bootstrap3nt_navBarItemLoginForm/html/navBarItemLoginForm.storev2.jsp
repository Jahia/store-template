...
<c:if test="${! renderContext.editMode}">
    <c:if test="${! renderContext.loggedIn}">
        ...
        <button class="btn btn-primary navbar-btn${pullClass} loginButton" type="button" data-toggle="modal" data-target="#loginForm_${currentNode.identifier}" style="color:black;">
...
<c:if test="${renderContext.loggedIn}">
    <ul class="nav navbar-nav${pullClass}">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle btn btn-primary loginButton button button-blue openb" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="color:black;padding:8px">
                <c:choose>
                    ...
                    <c:otherwise>
                        <img src="<c:url value='${url.currentModule}/img/user-black.png'/>" alt="${fn:escapeXml(firstname)} ${fn:escapeXml(lastname)}" height="16"/>
                    </c:otherwise>
                </c:choose>
